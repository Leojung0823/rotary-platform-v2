...
values
  ...
  -- Keep the status active to prove that the date window is an independent
  -- authorization condition; the end date has already passed.
  ('a5000000-0000-4000-8000-000000000006', 'a4000000-0000-4000-8000-000000000001', 'a2000000-0000-4000-8000-000000000006', 'active', current_date - 10, current_date - 1),
