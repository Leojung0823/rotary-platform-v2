...
-- This is intentionally a small, member-only projection. It never accepts a
-- client supplied identity, exposes internal identifiers, or replaces the
-- authorization checks on the event and check-in destinations.
