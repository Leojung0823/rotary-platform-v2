...
-- Adds a small "recent club activity" slice to the member home projection:
-- the last few ended, published events, with whether this member attended.
-- Kept minimal and bounded, matching the existing primary/next event shape.
