...
-- Reserve the manual Flex-template rollout key. No feature is enabled here.
...
alter table public.platform_feature_flags
  add constraint platform_feature_flags_feature_key_check check (feature_key in (
    ...
    'line_oa_onboarding_v1', 'line_oa_flex_templates_v1'
  ));
...
begin
  ...
  if p_feature_key not in (
    ...
    'line_oa_auto_pairing_v1', 'line_oa_event_push_v1', 'line_oa_onboarding_v1', 'line_oa_flex_templates_v1'
