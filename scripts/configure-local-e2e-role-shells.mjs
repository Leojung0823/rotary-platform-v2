...
const scenarios = {
  disabled: { roleShells: false, memberHome: false, checkinQr: false, gpsCheckin: false, attendanceUi: false, messageCenter: false, birthdayV2: false, birthdayCollection: false, archiveHandover: false, lineOaOnboarding: false, lineOaFlexTemplates: false, lineRichMenu: false, duesFinance: false },
  "member-home-disabled": { roleShells: true, memberHome: false, checkinQr: false, gpsCheckin: false, attendanceUi: false, messageCenter: false, birthdayV2: false, birthdayCollection: false, archiveHandover: false, lineOaOnboarding: false, lineOaFlexTemplates: false, lineRichMenu: false, duesFinance: false },
  "checkin-disabled": { roleShells: true, memberHome: true, checkinQr: false, gpsCheckin: false, attendanceUi: false, messageCenter: true, birthdayV2: false, birthdayCollection: false, archiveHandover: false, lineOaOnboarding: false, lineOaFlexTemplates: false, lineRichMenu: false, duesFinance: false },
  enabled: { roleShells: true, memberHome: true, checkinQr: true, gpsCheckin: true, attendanceUi: true, messageCenter: true, birthdayV2: true, birthdayCollection: true, archiveHandover: true, lineOaOnboarding: true, lineOaFlexTemplates: true, lineRichMenu: true, duesFinance: true },
};
...
for (const [featureKey, enabled] of [
  ...
  ["line_oa_onboarding_v1", scenario.lineOaOnboarding],
  ["line_oa_flex_templates_v1", scenario.lineOaFlexTemplates],
  ["line_rich_menu_v1", scenario.lineRichMenu],
  ["dues_finance_v1", scenario.duesFinance],
]) {
