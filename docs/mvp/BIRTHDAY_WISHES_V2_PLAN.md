...
### 5.2 沒有站內訊息中心 —— 已於 2026-08-22 補上

> **更新**：訊息中心已經實作（`docs/mvp/MESSAGE_CENTER_MVP_SCOPE.md`，
> flag `announcements_v09` 預設關閉）。以下是當初的缺口描述，保留作為脈絡。
> 徵集的「主動詢問」現在有管道了，剩下的前置條件只有排程機制（§5.1）。
