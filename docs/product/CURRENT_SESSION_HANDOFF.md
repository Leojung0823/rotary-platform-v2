# 交接筆記（持續更新；最新核對 2026-09-16，`main=a8f96f5`）
...
- PR #188、#189、#190 都已合併；`main@1ef38bb` 的合併後 CI 與 Browser Smoke 均已成功，且 Staging Go-Live `35083792540` 已發布 `1ef38bb`。最新 `main=a8f96f5` 只有文件同步，尚未重新部署；不要把 merge 或檢查通過當成部署證據。
